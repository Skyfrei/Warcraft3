...
TORCH_API ::std::tuple<at::Tensor,at::Tensor> std_mean_mps(const at::Tensor & self, at::OptionalIntArrayRef dim=c10::nullopt, const c10::optional<at::Scalar> & correction=c10::nullopt, bool keepdim=false);

...
//  Cooldown	Mana Cost	Casting Delay	Range	Area of Effect	Allowed
//  Targets	Effect	Hero Level Req 30 sec.	100	3 sec.	Unlimited
//  80	Friendly Ground Units, Friendly Buildings	Teleports up to 24 units
//  6
